...
const navStyle = "flex flex-row overflow-x-auto bg-gray-dark text-white text-xl h-16"
    ...
    <header className={headerStyle}>
        ...
        <nav className={navStyle}>
            <div className="sm:hidden md:block">
                <a href="/#"><img src="/logo.png" alt="Starboard" className="h-16" /></a>
            </div>
            <div className="flex flex-row justify-around">
                ...
                <div className="flex p-4 pl-0">
                    ...
                    <a className={aStyle} href="/#github">
                        <svg className={svgStyle} role="img" fill="#ffffff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
